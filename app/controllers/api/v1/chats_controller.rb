...
class ChatsController < ApiController
  ...
  def create
    ...
    sequence_id = last_chat ? last_chat.chat_number + 1 : 1
    @chat.write_attribute(:chat_number, sequence_id)
  ...
  private
    ...
    def set_chat
      @chat = Chat.find_by(chat_number: params[:id], application_id: params[:application_id])
    end
