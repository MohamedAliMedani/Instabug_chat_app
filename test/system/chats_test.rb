...
class ChatsTest < ApplicationSystemTestCase
  ...
  test "should create chat" do
    ...
    fill_in "Application", with: @chat.application_id
    fill_in "Chat number", with: @chat.chat_number
    fill_in "Messages count", with: @chat.messages_count
    check "is_deleted" if @chat.is_deleted
