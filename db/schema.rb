...
ActiveRecord::Schema[7.0].define(version: 2022_11_25_145934) do
  create_table "applications", id: :string, charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
